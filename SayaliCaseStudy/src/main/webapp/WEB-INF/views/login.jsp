...
<body>
	<h1 style= "font-family:verdana; color: white; text-shadow: 2px 2px #8a73ff"> Dollar Store Spoon University
	 ...
	 <section class="input_box">
		...
		<button style="width: 120px; height: 50px; font-family:verdana; font-size: 18px; color:#8a73ff ; box-shadow: 5px 5px 5px #ff7f73">Login</button>
		<input type="submit" value="Login" id ="login_button">
		<button style="width: 120px; height: 50px; font-family:verdana; font-size: 18px; color:#8a73ff ; box-shadow: 5px 5px 5px #ff7f73">New User?</button>
		<h4>${loginFailedMessage}</h4>
