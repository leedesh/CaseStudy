...
//	}
	...
	@PostMapping("/updaterecipe")
		public String showUpdateRecipePage(@ModelAttribute("userrecipe") UserRecipe userrec, Model model, BindingResult result, HttpSession session) {
		Users userlogin = (Users) session.getAttribute("currentuser");
		//	Users userlogin= new Users(1, "johncena@gmail.com", "12345");
			userrec.setUser(userlogin);
	...
	public String showDeleteRecipePage(@ModelAttribute("userrecipe") UserRecipe userrec,@RequestParam("userRecipeId")int userRecipeId, Model model, BindingResult result, HttpSession session) {
	Users userlogin = (Users) session.getAttribute("currentuser");
	//	Users userlogin= new Users(1, "johncena@gmail.com", "12345");
		userrec.setUser(userlogin);
